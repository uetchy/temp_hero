...
void testStinkerFight( void )
{
	...
	while( !endTestSession )
	{
		...
		case '1':
			// 刀なしのStinker戦闘
			stinkerFightLoop( princeStartHP, stinker1StartHP, 0 );
			break;
		case '2':
			// 刀ありのStinker戦闘
			stinkerFightLoop( princeStartHP, stinker1StartHP, 1 );
			break;
		case '3':
			// 刀なしのSuper Stinker戦闘
			superStinkerFightLoop( princeStartHP, superStinkerStartHP, 0 );
			break;
		case '4':
			// 刀ありのSuper Stinker戦闘
			superStinkerFightLoop( princeStartHP, superStinkerStartHP, 1 );
			break;
		case 'Q':
			endTestSession = 1;
			break;
