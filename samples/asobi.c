...
void testStinkerFight()
{
	...
	while( !endTestSession )
	{
		...
		printf( "1) 攻撃力が１でポーションを所持していない\n" );
		printf( "2) 攻撃力が２でポーションを所持していない\n" );
		printf( "3) 攻撃力が２でポーションを所持している\n" );
		printf( "4) 裏ボス戦　ポーション所持\n" );
		printf( "5) ボス線　攻撃力２でポーション所持\n" );
